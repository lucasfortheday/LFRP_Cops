i18n.importData("en", {
    ...
    cloackroom_take_service_ranger_title = "Cloack in as Park Ranger",
    cloackroom_take_service_normal_title = "Cloack in as Officer",
    cloackroom_take_service_sheriff_title = "Cloack in as Sheriff",
    cloackroom_take_service_chp_title = "Cloack in as State Trooper",
    cloackroom_take_service_prison_title = "Cloack in as a Prison Guard",
    cloackroom_take_service_hidden_title = "Cloack in as Detective",
    cloackroom_take_service_swat_title = "Cloack in as S.W.A.T",
    cloackroom_break_service_title = "Cloack out",
